...
// to the first thing found. The person then picks one from the UI, which
// triggers a real name-based connect via the library's normal start()
// path.
// ---------------------------------------------------------------------
...
void btaudio_connectToScanResult(int idx); // saves + connects to that name
