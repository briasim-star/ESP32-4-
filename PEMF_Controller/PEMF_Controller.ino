...
// Declared here (not down with the rest of the PIN-screen code) for the
// same reason Rect/Slider live in ui_types.h - Arduino auto-hoists function
// prototypes to the top of the file, so any custom type used as a function
// parameter has to already be known by that point.
