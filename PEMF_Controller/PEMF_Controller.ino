...
void drawCategoryScreen() {
  ...
  drawButton(btnSequences, "Sequences", COLOR_MUTED);
}
...
void drawRunScreen() {
  ...
  const char* startLabel = running ? "STOP" : (pendingSequenceIndex >= 0 ? "START (Sequence)" : "START");
