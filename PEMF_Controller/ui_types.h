...
enum Screen { SCR_WELCOME, SCR_SETUP_MODE, SCR_SETUP_LOGIN_CHOICE, SCR_TEXT_ENTRY, SCR_CATEGORY, SCR_LIST, SCR_RUN,
              ...
              SCR_PERSON_PICKER, SCR_MANAGE_PEOPLE, SCR_SEQUENCES, SCR_SOUNDSCAPES, SCR_WIFI_SETUP,
              SCR_GAMES_MENU, SCR_GAME_RIPPLE, SCR_GAME_BREATH, SCR_GAME_STILL, SCR_GAME_COLORFLOW,
              SCR_GAME_PULSE, SCR_GAME_ZEN, SCR_GAME_BUBBLE, SCR_GAME_MATCH, SCR_GAME_SAND, SCR_GAME_PETAL };
...
// to avoid.
enum SettingsItemId {
  SET_DEV_MODE, SET_GAMES, SET_CHECK_UPDATES, SET_BT_DEVICE,
  SET_ROOM_OR_PEOPLE, SET_SWITCH_USER, SET_WIFI, SET_VIEW_LOG,
  SET_SOUNDSCAPES, SET_FACTORY_RESET, SET_ITEM_COUNT
};
